...
[Render online](https://github.com/Un1Gfn/empty/wiki/_new)
...
Tethering RNDIS TFTP+BOOTP - Required infrastructure state

<!-- Guide RNDIS TFTP BOOTP Serial Mass bootloader kernel userspace NFS -->
|Guide|[RNDIS](https://en.wikipedia.org/wiki/RNDIS)[<sup>O</sup>](https://en.wikipedia.org/wiki/Ethernet_over_USB)<br>network|[TFTP](https://en.wikipedia.org/wiki/Trivial_File_Transfer_Protocol)|[BOOTP](https://en.wikipedia.org/wiki/Bootstrap_Protocol)|Serial|Mass<br>Storage|bootloader<br>build|kernel<br>build|userspace<br>build|NFS|
|-|-|-|-|-|-|-|-|-|-|
...
Hareware
* Beaglebone Green Wireless [Seeed wiki](http://wiki.seeedstudio.com/BeagleBone_Green_Wireless/#specification)
* Beaglebone Black [GitHub reference](https://github.com/beagleboard/beaglebone-black/wiki/System-Reference-Manual)
* [Texus Instruments Sitara AM3358](http://www.ti.com/product/AM3358) [Arm Cortex-A8])(https://en.wikipedia.org/wiki/ARM_Cortex-A8)
  * 32-bit [armhf](https://wiki.debian.org/ArmHardFloatPort#Supported_devices)[<sup>\*</sup>](https://wiki.debian.org/ArmEabiPort)
  * [Diagram](http://www.ti.com/data-sheets/diagram.tsp?genericPartNumber=AM3358&diagramId=SPRS717K)
  * [docs](http://www.ti.com/product/AM3358/technicaldocuments) &rarr; User guides &rarr; AM335x and AMIC110 Sitara™ Processors Technical Reference Manual
    * "Memery Map" &larr; Page 117 (2.1)
...
[deleted question](https://superuser.com/questions/1529130/linux-tethering-ethernet-over-usb-network-device-usb0-not-exposed-after-loading) [<sup>O</sup>](https://github.com/techniq/wiki/wiki/Linux-USB-Gadget-API#network-g_ether)

[Android USB SSH](https://stackoverflow.com/questions/44926644/control-beaglebone-black-linux-with-android-smartphone-through-usb-cable)
