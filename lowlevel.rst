...
redmi2(1/8) redmi2(2/16) redmi2pro(2/16) redmi2prime(2/16) :wp:`comparison <Redmi#Redmi_Series>`

| Qualcomm :pmos:`mainline porting`
|    :pmos:`Mainlining#Supported_SoCs`
| Qualcomm :wp:`CPU-SoC chart <list of Qualcomm Snapdragon processors>`
| Qualcomm :wp:`codecs <Qualcomm Hexagon#Hardware_codec_supported>`
...
| EDL equivalents
| samsung `exynos-usbdl <https://github.com/frederic/exynos-usbdl>`__
| mediatek mtk
...
| qualcomm
  ...
  :abbr:`WCNSS (Wireless Connectivity Subsystem)`
  [#Glossary]_
...
hyp" firmware replacement `qhypstub <https://github.com/msm8916-mainline/qhypstub>`__

:pmos`troubleshooting#Proprietary_blobs` - `themuppets <https://github.com/orgs/TheMuppets/repositories>`__

:pmos:`change kernel cmdline <troubleshooting:kernel#How_can_I_boot_the_kernel_with_some_specific_arguments.3F>`
...
.. literalinclude:: ../wt88047.lowlevel/system__build_prop
   :language: text
...
.. literalinclude:: ../wt88047.lowlevel/edl_printgpt.txt
   :language: text
...
.. warning::
   ...
   | lk1st method is broken
   | Writing l2nd to aboot gets stuck at ``05c6:9006 HSUSB BULK``
...
.. table::
   ...
   =========== =========================
    partition   data
   =========== =========================
    aboot       vendor fastboot
    boot        lk2nd 
    system      \- UNUSED \-
    userdata    \*xiaomi-wt88047.img.xz
   =========== =========================

:pmos:`QCDT` /boot/vmlinuz
...
.. table::
   ...
   ================= ==================== ============= ===========================
    \                 address              username      password      [#SSHpass]_
    default account   :kbd:`172.16.42.1`   :kbd:`user`   :kbd:`147147`            
   ================= ==================== ============= ===========================
