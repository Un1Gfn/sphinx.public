...
| Router
| |b| `DomyWifi DW33D <https://openwrt.org/toh/hwdata/domywifi/domywifi_dw33d>`__ |:question:| possible debrick by flashing SPI with clips?
| |b| `NetGear R7800/XR500 <https://openwrt.org/toh/netgear/r7800>`__ |:warning:| hard brick if on-flash u-boot is broken
